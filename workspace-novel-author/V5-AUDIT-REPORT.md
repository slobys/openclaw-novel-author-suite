...
> 本文件保留 V5.0 历史审计记录。当前配套版本为 Novel Author V6.1 Balanced-Fast / Novel Engine 0.6.0；默认篇幅为硬下限 2000、理想目标 2600、建议上限 3200，并继续保留逐章隔离 Writer、父会话确定性落盘、幂等取消、正文 Hash 变化和同稿循环阻断。
...
- 新增 5 个 V5 协议和 3 个模板；
- 历史版本曾以 companion patch 交付服务端门禁；公开版已由根目录 Novel Engine 0.6.0 直接提供，不再携带旧 ZIP 补丁。
