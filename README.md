# Novel Engine 0.4.1 — V5.2 Server Edition

面向 OpenClaw 长篇小说 Agent 的持久化工具插件。0.4.1 在 0.4.0 基础上统一 Agent/Engine 回执与正文 Hash 契约，修复 requestId 对账串单和修订审核提前覆盖，并收紧独立质量、Closure 与派生台账正文绑定。
