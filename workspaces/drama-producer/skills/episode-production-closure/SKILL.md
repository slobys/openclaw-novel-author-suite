...
6. Prove the dispatch boundary from state. Confirm next-episode dispatch is disabled, held for confirmation, or otherwise matches the declared policy, and confirm no duplicate submission occurred; closure has not created an unintended downstream job.
